...
Week3:
1. Enemy AI Behavior Tree 구현
2. 데미지 및 캐릭터 상태(죽음, 상태이상, 피격 등) 구현
3. 원거리 GA기반 스킬 구현

Week4:
1. Enemy Monster 구현 (Goblin Shaman, Ghoul, Demon Warrior, Demon Ranger)
2. 플레이어 XP 및 Levelup 구현
3. 패시브 스킬 구현

Week5:
1. 스킬창 구현 (스킬 포인트, 스킬 장착, 스킬 레벨 업 등)

...
{
	checkf(ImmutablePts.Num() >= NumPoints, TEXT("ImmutablePts out of bounds"));
	...
	for (USceneComponent* Pt : ImmutablePts)
	{
		...
		UAuraAbilitySystemLibrary::GetLivePlayerWithInRadius(this, IgnoreActors, TArray<AActor*>(), 1500, GetActorLocation());
